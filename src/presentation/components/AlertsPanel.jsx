...
import { go } from "../../lib/nav"; // 👈 helper de navegación
...
export default function AlertsPanel({ alerts = [] }) {
  return (
    <div className="bg-white rounded-2xl shadow-sm border p-4">
      ...
      <button
        type="button"
        onClick={() => go("history")} // 👈 navega a la vista de historial
        className="mt-3 w-full border rounded-xl px-3 py-2 text-indigo-600 hover:bg-indigo-50 flex items-center justify-center gap-2"
        aria-label="Ver historial de alertas"
      >
